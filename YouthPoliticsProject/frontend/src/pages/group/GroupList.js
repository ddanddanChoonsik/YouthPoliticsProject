...
const GroupList = () => {
    ...
    let countListUrl = process.env.REACT_APP_SPRING_URL+"group/totalCount";
    let alldataUrl = process.env.REACT_APP_SPRING_URL+"group/getAllDatas";
    ...
    //const pageConut = parseInt(countGroup/20 + 1) ; 
    ...
    */
    ...
    //detail 페이지 전환
    const onClick = (e, num) => {
        console.log("그룹모임 num : ", num);
        navi(`/group/detail/${num}`);
    }
    ...
    return (
        <div id='group'>
            ...
            <h3>그룹모임</h3>
            <br/>
            <div id='groupList' className='groupList'>
                <div>    
                    <div className='groupCount' >
                        <strong> 총 <span className='crimson-text'>{countGroup}</span> 건</strong>
                    </div>
                    ...
                    <Stack spacing={3} justifyContent="center" alignItems="center">
                        <TableContainer component={Paper} >
                            <Table  size="small" aria-label="a dense table" style={{minWidth:'1500px'}}>
                                ...
                                <TableBody>
                                {Object.values(allGroup).map((row,idx) => (
                ...
                <div className='newGroup'>
                        <button type='button' onClick={groupForm}>공지사항 작성</button>
                    </div> 
                    }
